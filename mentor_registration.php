...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    } elseif (strlen($mentorPassword) < 8 || !preg_match('/[^a-zA-Z0-9]/', $mentorPassword)) {
        $error_message = "Password must be at least 8 characters long and contain at least one special character.";
    } 
     else {
    ...
    <div class="container mt-5">
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            <div class="form-group">
                ...
                <input type="Email" name="mentor-username" class="form-control" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" name="mentor-contact" class="form-control" required>
            </div>
            <div class="form-group">
