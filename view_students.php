...
<body>
    ...
    <div class="main">
        <div class="left flex">
            ...
            ?></p>
                ...
                <!-- Direct Call Button -->
                <img src="whatsapp.jpg" alt="Small Logo"
                ...
                if (isset($_GET['id'])) {
                    ...
                    $studentId = $_GET['id'];
                    $sql = "SELECT contact FROM students WHERE id = '$studentId'";
                    $result = $conn->query($sql);
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        echo "<a href='tel:$phoneNumber' class='btn btn-success card-button' target='_blank'>Whatsapp Connect</a>";
                    } else {
                        echo "0 results";
                    }
                } else {
    ...
    <div class="counselling flex">
        ...
        <div class="counsellingContainer flex">
            <form action="submit_counseling.php?menteeId=<?php echo $menteeId; ?>" method="post"
                ...
                <div class="type flex">
                    ...
                    <textarea name="counseling_remark" placeholder="Enter the counseling remark" cols="30" rows="3"
                        required></textarea>
                </div>
                <div class="type flex">
                    <label for="counseling_suggestion">Counseling Suggestion</label>
                    <textarea name="counseling_suggestion" placeholder="Enter the counseling suggestion" cols="30"
